...
# ex: for Low SD:
import numpy
speed = [86,87,88,86,87,85,86] #+all the values and divide by total numbers,than + and - for two nearrest values minimum and maximum value
...
# As we learned the formula to find the SD is the square root of the variance.
